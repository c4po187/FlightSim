		...
		namespace Graphics {
			...
			class Viewport : public IApplicationObject {
				...
				public:
					...
					Viewport(int x, int y, U32 width, U32 height, std::string tag, Camera_sptr pcamera);
					Viewport(int x, int y, U32 width, U32 height, std::string tag, Camera_sptr pcamera, 
						Scene_sptr pscene);
					Viewport(int x, int y, U32 width, U32 height, std::string tag, const Vec4& color, 
						Scene_sptr pscene);
				...
				private:
					...
					std::string m_tag;
					Vec4 m_clearColor, m_borderColor;
